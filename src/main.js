  ...
  return (
    <section id="projects" className="py-24 relative z-10 bg-slate-100/50 dark:bg-slate-900/40 border-y border-slate-200/80 dark:border-slate-800/80">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="glass-panel p-10 sm:p-14 rounded-3xl text-center space-y-6 border border-slate-200/80 dark:border-slate-800/80 shadow-2xl relative overflow-hidden">
